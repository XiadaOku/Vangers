...
ServerFindChain::ServerFindChain(int IP,int port,char* domain_name,int game_ID,char* game_name)
{
	...
	if(!game_ID) {
		switch(RND(45)) {
			case 0: char *new_game_name = "Новая игра на cum "->GetValueCHR();
			case 1: char *new_game_name = "Новая игра на Ауф "->GetValueCHR();
			case 2: char *new_game_name = "Новая игра на шУе "->GetValueCHR();
			case 3: char *new_game_name = "Новая игра на Аид "->GetValueCHR();
			case 4: char *new_game_name = "Новая игра на хуЙ "->GetValueCHR();
			case 5: char *new_game_name = "Новая игра на pUF "->GetValueCHR();
			case 6: char *new_game_name = "Новая игра на Kiv "->GetValueCHR();
			case 7: char *new_game_name = "Новая игра на cx "->GetValueCHR();
			case 8: char *new_game_name = "Аид, гони cx на "->GetValueCHR();
			case 9: char *new_game_name = "Граф, гони лаунчер на "->GetValueCHR();
			case 10: char *new_game_name = "Новая игра на ппШ "->GetValueCHR();
			case 11: char *new_game_name = "Скачать мод на "->GetValueCHR();
			case 12: char *new_game_name = "Скачать спрайты на "->GetValueCHR();
			case 13: char *new_game_name = "Сделать панацею на "->GetValueCHR();
			case 14: char *new_game_name = "Сделать костыли на "->GetValueCHR();
			case 15: char *new_game_name = "Забанить свина на "->GetValueCHR();
			case 16: char *new_game_name = "Забанить Элипода на "->GetValueCHR();
			case 17: char *new_game_name = "Изучить мат анализ на "->GetValueCHR();
			case 18: char *new_game_name = "Написать говнокод на "->GetValueCHR();
			case 19: char *new_game_name = "Скомпилировать В на "->GetValueCHR();
			case 20: char *new_game_name = "Удалить сервер "->GetValueCHR();
			case 21: char *new_game_name = "Положить сервер "->GetValueCHR();
			case 22: char *new_game_name = "Позвать ФЕКа на "->GetValueCHR();
			case 23: char *new_game_name = "Обогнать Торгаша на "->GetValueCHR();
			case 24: char *new_game_name = "Убить Димона на "->GetValueCHR();
			case 25: char *new_game_name = "Получить бан на "->GetValueCHR();
			case 26: char *new_game_name = "Создать чат о "->GetValueCHR();
			case 27: char *new_game_name = "Хай дуду, пошел в пизду"->GetValueCHR();
			case 28: char *new_game_name = "Ущемлять муркота на "->GetValueCHR();
			case 29: char *new_game_name = "Буллить муркота на "->GetValueCHR();
			case 30: char *new_game_name = "Свергнуть муркота на "->GetValueCHR();
			case 31: char *new_game_name = "Предать муркота на "->GetValueCHR();
			case 32: char *new_game_name = "Импостить на "->GetValueCHR();
			case 33: char *new_game_name = "Играть в among ass на "->GetValueCHR();
			case 34: char *new_game_name = "Заказать арт у хомяка на "->GetValueCHR();
			case 35: char *new_game_name = "Послушать ковер на "->GetValueCHR();
			case 36: char *new_game_name = "Найти фембоев на "->GetValueCHR();
			case 37: char *new_game_name = "Стать фурри на "->GetValueCHR();
			case 38: char *new_game_name = "Стать пешкой на "->GetValueCHR();
			case 39: char *new_game_name = "Нарушить правила на "->GetValueCHR();
			case 40: char *new_game_name = "Дебажить на "->GetValueCHR();
			case 41: char *new_game_name = "Тестить на "->GetValueCHR();
			case 42: char *new_game_name = "Ставить Линукс на "->GetValueCHR();
			case 43: char *new_game_name = "НЁХ на "->GetValueCHR();
			case 44: char *new_game_name = "Переводить на "->GetValueCHR();
			default: char *new_game_name = "Ксиаде нечего делать на "->GetValueCHR();				
		}
