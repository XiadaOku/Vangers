...
ServerFindChain::ServerFindChain(int IP,int port,char* domain_name,int game_ID,char* game_name)
{
	...
	if(!game_ID) {
		switch(RND(46)) {
			case 0: new_game_name = "Новая игра на cum "; break;
			case 1: new_game_name = "Новая игра на Ауф "; break;
			case 2: new_game_name = "Новая игра на шУе "; break;
			case 3: new_game_name = "Новая игра на Аид "; break;
			case 4: new_game_name = "Новая игра на хуЙ "; break;
			case 5: new_game_name = "Новая игра на pUF "; break;
			case 6: new_game_name = "Новая игра на Kiv "; break;
			case 7: new_game_name = "Новая игра на cx "; break;
			case 8: new_game_name = "Аид, гони cx на "; break;
			case 9: new_game_name = "Граф, гони лаунчер на "; break;
			case 10: new_game_name = "Новая игра на ппШ "; break;
			case 11: new_game_name = "Скачать мод на "; break;
			case 12: new_game_name = "Скачать спрайты на "; break;
			case 13: new_game_name = "Сделать панацею на "; break;
			case 14: new_game_name = "Сделать костыли на "; break;
			case 15: new_game_name = "Забанить свина на "; break;
			case 16: new_game_name = "Забанить Элипода на "; break;
			case 17: new_game_name = "Изучить мат анализ на "; break;
			case 18: new_game_name = "Написать говнокод на "; break;
			case 19: new_game_name = "Скомпилировать В на "; break;
			case 20: new_game_name = "Удалить сервер "; break;
			case 21: new_game_name = "Положить сервер "; break;
			case 22: new_game_name = "Позвать ФЕКа на "; break;
			case 23: new_game_name = "Обогнать Торгаша на "; break;
			case 24: new_game_name = "Убить Димона на "; break;
			case 25: new_game_name = "Получить бан на "; break;
			case 26: new_game_name = "Создать чат о "; break;
			case 27: new_game_name = "Хай дуду, пошел в пизду"; break;
			case 28: new_game_name = "Ущемлять муркота на "; break;
			case 29: new_game_name = "Буллить муркота на "; break;
			case 30: new_game_name = "Свергнуть муркота на "; break;
			case 31: new_game_name = "Предать муркота на "; break;
			case 32: new_game_name = "Импостить на "; break;
			case 33: new_game_name = "Играть в among ass на "; break;
			case 34: new_game_name = "Заказать арт у хомяка на "; break;
			case 35: new_game_name = "Послушать ковер на "; break;
			case 36: new_game_name = "Найти фембоев на "; break;
			case 37: new_game_name = "Стать фурри на "; break;
			case 38: new_game_name = "Стать пешкой на "; break;
			case 39: new_game_name = "Нарушить правила на "; break;
			case 40: new_game_name = "Дебажить на "; break;
			case 41: new_game_name = "Тестить на "; break;
			case 42: new_game_name = "Ставить Линукс на "; break;
			case 43: new_game_name = "НЁХ на "; break;
			case 44: new_game_name = "Переводить на "; break;
...
MessageElement::MessageElement(const char* player_name, char* msg,int col)
{
    ...
    if (strncmp(msg, bot_tag, 5)==0) {
        ...
        actual_col = 3;
		is_start = 1;
	} else if (strcmp(msg, "/finish")==0  && is_start==2) {
		name = (char*)"$";
