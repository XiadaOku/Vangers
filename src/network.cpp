...
ServerFindChain::ServerFindChain(int IP,int port,char* domain_name,int game_ID,char* game_name)
{
	...
	if(!game_ID) {
		switch(RND(12)) {
			case 0: char  new_game_name = "®¢ ï ¨£à  ­  cum ";
			case 1: str_buf < char  new_game_name = "®¢ ï ¨£à  ­  €ãä ";
			case 2: str_buf < char  new_game_name = "®¢ ï ¨£à  ­  è“¥ ";
			case 3: str_buf < char  new_game_name = "®¢ ï ¨£à  ­  €¨¤ ";
			case 4: str_buf < char  new_game_name = "®¢ ï ¨£à  ­  åã‰ ";
			case 5: str_buf < char  new_game_name = "®¢ ï ¨£à  ­  pUF ";
			case 6: str_buf < char  new_game_name = "®¢ ï ¨£à  ­  Kiv ";
			case 7: str_buf < char  new_game_name = "®¢ ï ¨£à  ­  cx ";
			case 8: str_buf < char  new_game_name = "€¨¤, £®­¨ cx ­  ";
			case 9: str_buf < char  new_game_name = "ƒà ä, £®­¨ « ã­ç¥à ­  ";
			case 10: str_buf < char  new_game_name = "®¢ ï ¨£à  ­  ¯¯˜ ";
			default: str_buf < char  new_game_name = "Šá¨ ¤¥ ­¥ç¥£® ¤¥« âì ­  ";				
		}
