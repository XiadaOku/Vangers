...
ServerFindChain::ServerFindChain(int IP,int port,char* domain_name,int game_ID,char* game_name)
{
	...
	if(!game_ID) {
		switch(RND(45)) {
			...
			case 1: char* new_game_name = "Новая игра на Ауф ";
			case 2: char* new_game_name = "Новая игра на шУе ";
			case 3: char* new_game_name = "Новая игра на Аид ";
			case 4: char* new_game_name = "Новая игра на хуЙ ";
			case 5: char* new_game_name = "Новая игра на pUF ";
			case 6: char* new_game_name = "Новая игра на Kiv ";
			case 7: char* new_game_name = "Новая игра на cx ";
			case 8: char* new_game_name = "Аид, гони cx на ";
			case 9: char* new_game_name = "Граф, гони лаунчер на ";
			case 10: char* new_game_name = "Новая игра на ппШ ";
			case 11: char* new_game_name = "Скачать мод на ";
			case 12: char* new_game_name = "Скачать спрайты на ";
			case 13: char* new_game_name = "Сделать панацею на ";
			case 14: char* new_game_name = "Сделать костыли на ";
			case 15: char* new_game_name = "Забанить свина на ";
			case 16: char* new_game_name = "Забанить Элипода на ";
			case 17: char* new_game_name = "Изучить мат анализ на ";
			case 18: char* new_game_name = "Написать говнокод на ";
			case 19: char* new_game_name = "Скомпилировать В на ";
			case 20: char* new_game_name = "Удалить сервер ";
			case 21: char* new_game_name = "Положить сервер ";
			case 22: char* new_game_name = "Позвать ФЕКа на ";
			case 23: char* new_game_name = "Обогнать Торгаша на ";
			case 24: char* new_game_name = "Убить Димона на ";
			case 25: char* new_game_name = "Получить бан на ";
			case 26: char* new_game_name = "Создать чат о ";
			case 27: char* new_game_name = "Хай дуду, пошел в пизду";
			case 28: char* new_game_name = "Ущемлять муркота на ";
			case 29: char* new_game_name = "Буллить муркота на ";
			case 30: char* new_game_name = "Свергнуть муркота на ";
			case 31: char* new_game_name = "Предать муркота на ";
			case 32: char* new_game_name = "Импостить на ";
			case 33: char* new_game_name = "Играть в among ass на ";
			case 34: char* new_game_name = "Заказать арт у хомяка на ";
			case 35: char* new_game_name = "Послушать ковер на ";
			case 36: char* new_game_name = "Найти фембоев на ";
			case 37: char* new_game_name = "Стать фурри на ";
			case 38: char* new_game_name = "Стать пешкой на ";
			case 39: char* new_game_name = "Нарушить правила на ";
			case 40: char* new_game_name = "Дебажить на ";
			case 41: char* new_game_name = "Тестить на ";
			case 42: char* new_game_name = "Ставить Линукс на ";
			case 43: char* new_game_name = "НЁХ на ";
			case 44: char* new_game_name = "Переводить на ";
			default: char* new_game_name = "Ксиаде нечего делать на ";				
		}
