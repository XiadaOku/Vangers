...
ServerFindChain::ServerFindChain(int IP,int port,char* domain_name,int game_ID,char* game_name)
{
	...
	if(!game_ID) {
		switch(RND(45)) {
			case 0: const char* new_game_name = "Новая игра на cum ";
			case 1: const char* new_game_name = "Новая игра на Ауф ";
			case 2: const char* new_game_name = "Новая игра на шУе ";
			case 3: const char* new_game_name = "Новая игра на Аид ";
			case 4: const char* new_game_name = "Новая игра на хуЙ ";
			case 5: const char* new_game_name = "Новая игра на pUF ";
			case 6: const char* new_game_name = "Новая игра на Kiv ";
			case 7: const char* new_game_name = "Новая игра на cx ";
			case 8: const char* new_game_name = "Аид, гони cx на ";
			case 9: const char* new_game_name = "Граф, гони лаунчер на ";
			case 10: const char* new_game_name = "Новая игра на ппШ ";
			case 11: const char* new_game_name = "Скачать мод на ";
			case 12: const char* new_game_name = "Скачать спрайты на ";
			case 13: const char* new_game_name = "Сделать панацею на ";
			case 14: const char* new_game_name = "Сделать костыли на ";
			case 15: const char* new_game_name = "Забанить свина на ";
			case 16: const char* new_game_name = "Забанить Элипода на ";
			case 17: const char* new_game_name = "Изучить мат анализ на ";
			case 18: const char* new_game_name = "Написать говнокод на ";
			case 19: const char* new_game_name = "Скомпилировать В на ";
			case 20: const char* new_game_name = "Удалить сервер ";
			case 21: const char* new_game_name = "Положить сервер ";
			case 22: const char* new_game_name = "Позвать ФЕКа на ";
			case 23: const char* new_game_name = "Обогнать Торгаша на ";
			case 24: const char* new_game_name = "Убить Димона на ";
			case 25: const char* new_game_name = "Получить бан на ";
			case 26: const char* new_game_name = "Создать чат о ";
			case 27: const char* new_game_name = "Хай дуду, пошел в пизду";
			case 28: const char* new_game_name = "Ущемлять муркота на ";
			case 29: const char* new_game_name = "Буллить муркота на ";
			case 30: const char* new_game_name = "Свергнуть муркота на ";
			case 31: const char* new_game_name = "Предать муркота на ";
			case 32: const char* new_game_name = "Импостить на ";
			case 33: const char* new_game_name = "Играть в among ass на ";
			case 34: const char* new_game_name = "Заказать арт у хомяка на ";
			case 35: const char* new_game_name = "Послушать ковер на ";
			case 36: const char* new_game_name = "Найти фембоев на ";
			case 37: const char* new_game_name = "Стать фурри на ";
			case 38: const char* new_game_name = "Стать пешкой на ";
			case 39: const char* new_game_name = "Нарушить правила на ";
			case 40: const char* new_game_name = "Дебажить на ";
			case 41: const char* new_game_name = "Тестить на ";
			case 42: const char* new_game_name = "Ставить Линукс на ";
			case 43: const char* new_game_name = "НЁХ на ";
			case 44: const char* new_game_name = "Переводить на ";
			default: const char* new_game_name = "Ксиаде нечего делать на ";				
		}
