...
ServerFindChain::ServerFindChain(int IP,int port,char* domain_name,int game_ID,char* game_name)
{
	...
	if(!game_ID) {
	    if (lang() == RUSSIAN) {
			...
			switch(RND(8)) {
				case 0: str_buf < "®¢ ï ¨£à  ­  cum ";
				case 1: str_buf < "®¢ ï ¨£à  ­  €ãä ";
				case 2: str_buf < "®¢ ï ¨£à  ­  è“¥ ";
				case 3: str_buf < "®¢ ï ¨£à  ­  €¨¤ ";
				case 4: str_buf < "®¢ ï ¨£à  ­  åã‰ ";
				case 5: str_buf < "®¢ ï ¨£à  ­  pUF";
				case 6: str_buf < "®¢ ï ¨£à  ­  Kiv";
				case 7: str_buf < "Šá¨ ¤¥ ­¥ç¥£® ¤¥« âì ­  ";				
			}
        } else {
            str_buf < "New Game on ";
        }
