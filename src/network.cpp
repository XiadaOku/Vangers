...
ServerFindChain::ServerFindChain(int IP,int port,char* domain_name,int game_ID,char* game_name)
{
	...
	if(!game_ID) {
		switch(RND(45)) {
			case 0: char* new_game_name[255] = "Новая игра на cum ";
			case 1: char* new_game_name[255] = "Новая игра на Ауф ";
			case 2: char* new_game_name[255] = "Новая игра на шУе ";
			case 3: char* new_game_name[255] = "Новая игра на Аид ";
			case 4: char* new_game_name[255] = "Новая игра на хуЙ ";
			case 5: char* new_game_name[255] = "Новая игра на pUF ";
			case 6: char* new_game_name[255] = "Новая игра на Kiv ";
			case 7: char* new_game_name[255] = "Новая игра на cx ";
			case 8: char* new_game_name[255] = "Аид, гони cx на ";
			case 9: char* new_game_name[255] = "Граф, гони лаунчер на ";
			case 10: char* new_game_name[255] = "Новая игра на ппШ ";
			case 11: char* new_game_name[255] = "Скачать мод на ";
			case 12: char* new_game_name[255] = "Скачать спрайты на ";
			case 13: char* new_game_name[255] = "Сделать панацею на ";
			case 14: char* new_game_name[255] = "Сделать костыли на ";
			case 15: char* new_game_name[255] = "Забанить свина на ";
			case 16: char* new_game_name[255] = "Забанить Элипода на ";
			case 17: char* new_game_name[255] = "Изучить мат анализ на ";
			case 18: char* new_game_name[255] = "Написать говнокод на ";
			case 19: char* new_game_name[255] = "Скомпилировать В на ";
			case 20: char* new_game_name[255] = "Удалить сервер ";
			case 21: char* new_game_name[255] = "Положить сервер ";
			case 22: char* new_game_name[255] = "Позвать ФЕКа на ";
			case 23: char* new_game_name[255] = "Обогнать Торгаша на ";
			case 24: char* new_game_name[255] = "Убить Димона на ";
			case 25: char* new_game_name[255] = "Получить бан на ";
			case 26: char* new_game_name[255] = "Создать чат о ";
			case 27: char* new_game_name[255] = "Хай дуду, пошел в пизду";
			case 28: char* new_game_name[255] = "Ущемлять муркота на ";
			case 29: char* new_game_name[255] = "Буллить муркота на ";
			case 30: char* new_game_name[255] = "Свергнуть муркота на ";
			case 31: char* new_game_name[255] = "Предать муркота на ";
			case 32: char* new_game_name[255] = "Импостить на ";
			case 33: char* new_game_name[255] = "Играть в among ass на ";
			case 34: char* new_game_name[255] = "Заказать арт у хомяка на ";
			case 35: char* new_game_name[255] = "Послушать ковер на ";
			case 36: char* new_game_name[255] = "Найти фембоев на ";
			case 37: char* new_game_name[255] = "Стать фурри на ";
			case 38: char* new_game_name[255] = "Стать пешкой на ";
			case 39: char* new_game_name[255] = "Нарушить правила на ";
			case 40: char* new_game_name[255] = "Дебажить на ";
			case 41: char* new_game_name[255] = "Тестить на ";
			case 42: char* new_game_name[255] = "Ставить Линукс на ";
			case 43: char* new_game_name[255] = "НЁХ на ";
			case 44: char* new_game_name[255] = "Переводить на ";
			default: char* new_game_name[255] = "Ксиаде нечего делать на ";				
		}
		str_buf < new_game_name[255];
	}
	if(!game_name)
		if(domain_name)
			str_buf < domain_name;
