...
ServerFindChain::ServerFindChain(int IP,int port,char* domain_name,int game_ID,char* game_name)
{
	...
	if(!game_ID) {
		switch(RND(46)) {
			...
			case 3: new_game_name = "Новая игра на Аид ";
			case 4: new_game_name = "Новая игра на хуЙ ";
			case 5: new_game_name = "Новая игра на pUF ";
			case 6: new_game_name = "Новая игра на Kiv ";
			case 7: new_game_name = "Новая игра на cx ";
			case 8: new_game_name = "Аид, гони cx на ";
			case 9: new_game_name = "Граф, гони лаунчер на ";
			case 10: new_game_name = "Новая игра на ппШ ";
			case 11: new_game_name = "Скачать мод на ";
			case 12: new_game_name = "Скачать спрайты на ";
			case 13: new_game_name = "Сделать панацею на ";
			case 14: new_game_name = "Сделать костыли на ";
			case 15: new_game_name = "Забанить свина на ";
			case 16: new_game_name = "Забанить Элипода на ";
			case 17: new_game_name = "Изучить мат анализ на ";
			case 18: new_game_name = "Написать говнокод на ";
			case 19: new_game_name = "Скомпилировать В на ";
			case 20: new_game_name = "Удалить сервер ";
			case 21: new_game_name = "Положить сервер ";
			case 22: new_game_name = "Позвать ФЕКа на ";
			case 23: new_game_name = "Обогнать Торгаша на ";
			case 24: new_game_name = "Убить Димона на ";
			case 25: new_game_name = "Получить бан на ";
			case 26: new_game_name = "Создать чат о ";
			case 27: new_game_name = "Хай дуду, пошел в пизду";
			case 28: new_game_name = "Ущемлять муркота на ";
			case 29: new_game_name = "Буллить муркота на ";
			case 30: new_game_name = "Свергнуть муркота на ";
			case 31: new_game_name = "Предать муркота на ";
			case 32: new_game_name = "Импостить на ";
			case 33: new_game_name = "Играть в among ass на ";
			case 34: new_game_name = "Заказать арт у хомяка на ";
			case 35: new_game_name = "Послушать ковер на ";
			case 36: new_game_name = "Найти фембоев на ";
			case 37: new_game_name = "Стать фурри на ";
			case 38: new_game_name = "Стать пешкой на ";
			case 39: new_game_name = "Нарушить правила на ";
			case 40: new_game_name = "Дебажить на ";
			case 41: new_game_name = "Тестить на ";
